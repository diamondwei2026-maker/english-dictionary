<template>
  ...
  <view
    ...
    @click="$emit('click')"
  >
    <view class="word-card__main" :class="{ 'word-card__main--flex': variant === 'default' }">
      ...
      <text
        ...
        class="iconfont word-card__arrow"
      >&#xe002;</text>
    </view>
  </view>
</template>
...
.word-card {
  ...
  &__arrow {
    font-size: 30rpx;        /* Phase1(src): HomeView.tsx:223 — ArrowRight size 15 → font-size 30rpx */
    color: #D1D5DB;
    flex-shrink: 0;
