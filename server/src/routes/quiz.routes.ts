...
import { authMiddleware, optionalAuth, aiLimiter } from "../middleware/index.js";
...
// POST /quiz/generate — AI 出题（需认证 + AI 限流，不限管理员）
router.post("/generate", authMiddleware, aiLimiter, quizController.generateQuestions);
