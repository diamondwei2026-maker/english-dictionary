...
| 4.3 | 前端 AI 功能集成 | 阶段4: AI 词条生成 | ✅ done | P1 | 4.1 | [task.md](./tasks/english-dict-v1/task-4.3/task.md) |
...
| 6.3 | API 文档与安全配置 | 阶段6: 优化与上线 | ✅ done | P2 | 6.2 | [task.md](./tasks/english-dict-v1/task-6.3/task.md) |
